...
<html lang="id">
	<head>
		<title>Validasi Tanda Tangan Balai Guru Penggerak Provinsi  <?php echo $_ENV['DEFAULT_PROVINSI']; ?></title>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="main-download">
							<div class="main-title">Validasi Tanda Tangan</div>
							<div class="row">
								<div class="col-md-6 col-md-offset-3">
									<table class="table table-hover table-striped" style="width: 100%">
										<tr>
											<td width="30%">Jenis Berkas</td>
											<td width="2%">:</td>
											<td><?php print $jenis_berkas; ?></td>
										</tr>
										
										<?php
											if (!empty($detail)) {
												foreach ($detail as $detKey => $detVal) {
													$label = str_replace("_", " ", $detKey);
													
													if ($detKey == "Tgl_Surat_Tugas") {
														$detVal = $this->utility->formatDateIndo($detVal);
													}
													
													if ($detKey == "Disetujui_Tgl") {
														$detVal = $this->utility->formatDateIndo($detVal);
													}
