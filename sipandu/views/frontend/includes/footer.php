...
<script src="<?php print base_url('assets/js/table.js'); ?>"></script>
<script src="<?php print base_url('assets/plugins/rating/rating.js'); ?>"></script>
<script src="<?php print base_url('assets/js/guest.js?v=2'); ?>"></script>
</body>
</html>