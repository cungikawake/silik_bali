				...
				<div class="row">
					<div class="col-md-12">
						<div class="main-download">
							<div class="main-title">Tembak SPPD Kegiatan</div>
							<div class="row">
								<div class="col-md-4 col-md-offset-4">
									<form class="form-certificate" action="<?php print base_url("/download/tembak_sppd_peserta/".$kegiatan_id."/execute/"); ?>" method="get">
										<div class="form-group form-download">
											<label>Nama Pejabat Penerima SPD</label>
											<select class="form-control select2" name="pejabat">
												<?php
													if (isset($pejabat) && !empty($pejabat)) {
														foreach ($pejabat as $pej) {
															print '<option value="'.$pej["id"].'">'.$pej["nama"].'</option>';
														}
													}
												?>
											</select>
										...
										<div class="form-group form-download">
											<button type="submit" class="btn btn-info get-certifcate">Tembak SPPD</button>
										</div>
									</form>
								</div>
							</div>
