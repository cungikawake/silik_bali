	...
	<tr>
		<td>
			...
			<table width="100%" style="margin-bottom:15px;" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td colspan="3" class="font4">&nbsp;</td>
				</tr>
				<tr>
					<td width="28%" style="padding-left:28px;padding-top:5px;">Nama</td>
					<td width="2%">:</td>
				...
				<tr>
					<td colspan="3">
						<?php
							if (isset($penugasan)) {
								print "melaksanakan tugas :";
							}
							else if (isset($kegiatan)) {
								print "mengikuti kegiatan :";
							}
						?>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<?php
							...
							if (isset($penugasan)) {
								$tgl_mulai = $item["tgl_mulai_tugas"];
								$tgl_selesai = $item["tgl_selesai_tugas"];
							}
							else if (isset($kegiatan)) {
								$tgl_mulai = $kegiatan["tgl_mulai_kegiatan"];
								$tgl_selesai = $kegiatan["tgl_selesai_kegiatan"];
							}
						
							print $this->utility->formatRangeDate($tgl_mulai, $tgl_selesai);
						?>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="padding-left:28px;">Nomor <?php print $spj_item["jenis_surat"]; ?></td>
					<td width="2%">:</td>
					<td><?php print $spj_item["nomor_surat"]; ?></td>
				</tr>
				<tr>
					<td style="padding-left:28px;">Tgl <?php print $spj_item["jenis_surat"]; ?></td>
					<td width="2%">:</td>
			...
			<table width="100%" cellpadding="1" cellspacing="0" style="margin-top:10px;">
				...
				<tr>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td><?php if(!empty($spj_item["nip"]) && $spj_item["nip"] != "-") { print "NIP ".$spj_item["nip"]; } ?></td>
				</tr>
			</table>
		</td>
	</tr>
