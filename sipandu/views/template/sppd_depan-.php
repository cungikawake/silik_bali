		...
		<td>
						...
						<td width="43%">
							<table width="100%" cellpadding="0" cellspacing="0">
								...
								<tr>
									...
									<td style="font-size: 11px;">: <?php print $item["nomor_surat"]; ?></td>
								</tr>
								<tr>
									<td width="26%">Nomor</td>
									<td style="font-size: 11px;">: <?php print $this->utility->penomoran($item["no_urut"])."/SPD/".$item["kode_unsur"]."/".$satker["kode_satker"]."/".$item["dipa_kro"].".".$item["dipa_komponen"].".".$item["dipa_sub_komponen"]."/".date("Y", strtotime($kegiatan["tgl_selesai_kegiatan"])); ?></td>
								</tr>
							</table>
						</td>
					</tr>
			...
			<table width="100%" class="bordered" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td>
						<div><?php print $pejabat["ppk"]["nama"]; ?></div>
						<div>NIP <?php print $pejabat["ppk"]["nip"]; ?></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><?php print $item["deskripsi_kuitansi"]; ?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<div>a. <?php print $item["transport_asal"]; ?></div>
						<div>b. <?php print $item["transport_tujuan"]; ?></div>
					</td>
				</tr>
				<tr>
					...
					<?php
						$diff = $this->utility->lama_tugas($kegiatan["tgl_mulai_kegiatan"], $kegiatan["tgl_selesai_kegiatan"]);
					?>
					<td>
						<div>a. <?php print $diff; ?> hari</div>
						<div>b. <?php print $this->utility->formatDateIndo($kegiatan["tgl_mulai_kegiatan"]); ?></div>
						<div>c. <?php print $this->utility->formatDateIndo($kegiatan["tgl_selesai_kegiatan"]); ?></div>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						...
						<div>b. <?php print $item["dipa_program"]." / ".$item["dipa_kegiatan"].".".$item["dipa_kro"].".".$item["dipa_ro"].".".$item["dipa_komponen"].".".$item["dipa_sub_komponen"].".".$item["dipa_akun_transport"]; ?></div>
					</td>
				</tr>
				<tr>
			...
			<table width="100%" cellpadding="1" cellspacing="0" style="margin-top:10px;">
				...
				<tr>
					<td>&nbsp;</td>
					<td><?php print $pejabat["ppk"]["nama"]; ?></td>
				</tr>
				<tr>
					<td width="71.1%">&nbsp;</td>
					<td width="28.9%">NIP <?php print $pejabat["ppk"]["nip"]; ?></td>
				</tr>
			</table>
		</td>
	</tr>
