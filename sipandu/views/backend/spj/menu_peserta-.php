<div id="keg-more-opt-peserta" class="collapse">
	<input type="hidden" class="unsur-spj" value="peserta" />
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>Program</label>
										<input type="text" name="dipa_program" placeholder="<?php print $placeHolder["dipa_program"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_program"])) ? $options["dipa_program"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>Kegiatan</label>
										<input type="text" name="dipa_kegiatan" placeholder="<?php print $placeHolder["dipa_kegiatan"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_kegiatan"])) ? $options["dipa_kegiatan"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>KRO</label>
										<input type="text" name="dipa_kro" placeholder="<?php print $placeHolder["dipa_kro"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_kro"])) ? $options["dipa_kro"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>RO</label>
										<input type="text" name="dipa_ro" placeholder="<?php print $placeHolder["dipa_ro"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_ro"])) ? $options["dipa_ro"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>Komponen</label>
										<input type="text" name="dipa_komponen" placeholder="<?php print $placeHolder["dipa_komponen"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_komponen"])) ? $options["dipa_komponen"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>Sub Kom.</label>
										<input type="text" name="dipa_sub_komponen" placeholder="<?php print $placeHolder["dipa_sub_komponen"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_sub_komponen"])) ? $options["dipa_sub_komponen"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group form-group-sm">
										<label>Akun Trans.</label>
										<input type="text" name="dipa_akun_transport" placeholder="<?php print $placeHolder["dipa_akun_transport"]; ?>" required class="form-control" value="<?php print (isset($options["dipa_akun_transport"])) ? $options["dipa_akun_transport"] : ""; ?>" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group form-group-sm">
										...
										<input type="text" name="nomor_surat" required class="form-control" value="<?php print (isset($options["nomor_surat"])) ? $options["nomor_surat"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group form-group-sm">
										<label>Tanggal Surat</label>
										<input type="text" name="tgl_surat" required class="form-control datepicker" value="<?php print (isset($options["tgl_surat"])) ? $options["tgl_surat"] : ""; ?>" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group form-group-sm">
										...
										<select id="select_spby" data-unsur="peserta" class="form-control" name="penerima_spby" data-selected="<?php print (isset($options["penerima_spby"])) ? $options["penerima_spby"] : "0"; ?>"></select>
									</div>
									<div class="form-group form-group-sm">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group form-group-sm">
										...
										<input type="text" name="nomor_spm" placeholder="<?php print $placeHolder["nomor_spm"]; ?>" required class="form-control" value="<?php print (isset($options["nomor_spm"])) ? $options["nomor_spm"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group form-group-sm">
										<label>Tanggal SPM</label>
										<input type="text" name="tgl_spm" placeholder="<?php print $placeHolder["tgl_spm"]; ?>" required class="form-control datepicker" value="<?php print (isset($options["tgl_spm"])) ? $options["tgl_spm"] : ""; ?>" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group form-group-sm">
										...
										<input type="text" name="pagu_transport" required class="form-control autoNumeric" value="<?php print (isset($options["pagu_transport"])) ? $options["pagu_transport"] : ""; ?>" />
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group form-group-sm">
										<label>Pagu Uang Harian</label>
										<input type="text" name="pagu_uang_harian" required class="form-control autoNumeric" value="<?php print (isset($options["pagu_uang_harian"])) ? $options["pagu_uang_harian"] : ""; ?>" />
									</div>
								</div>
							</div>
						</div>
