			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php
						...
						$this->bootgrid->setTable("spj_kegiatan_peserta", $conditions);
						$this->bootgrid->sortBy("no_urut");
						$this->bootgrid->sortType("ASC");
						$this->bootgrid->setTitle("TRANSPORT");
						...
						$printBtn = array(
							"class" => "printSpby",
							"title" => "Print SPBy",
							"icon" => "fas fa-file mr-0"
						);
						$this->bootgrid->setToolbarButton($printBtn);
						
						$printBtn = array(
							"class" => "printDaftarPenerimaan",
							"title" => "Print Daftar Penerimaan",
						...
						$editButton = array(
							...
							"modal" => array(
								"view" => "backend/spj/modal_edit_peserta"
							)
						);
					...
					<div class="spj-realisasi">
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-12">
										<div id="table-realisasi-peserta">
...
<script src="<?php print base_url('assets/js/spj.js?v=2'); ?>"></script>
