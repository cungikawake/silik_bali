<style type="text/css">
	...
	.penugasan-kegiatan, .penugasan-monev-sec {
		border: 1px solid #ccc;
		padding: 15px;
		box-shadow: #ccc 0px 1px 5px;
		background: #fff;
...
<div class="modal-dialog modal-dialog-centered" role="document">
	<div class="modal-content">
		...
		<form action="/admin/kepegawaian/save_penugasan_kegiatan" method="post" class="form-penugasan">
			...
			<div class="modal-body">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-6">
								...
								<input type="text" name="tgl_surat" required autocomplete="off" class="form-control datepicker" value="<?php print $tglShow; ?>" />
							</div>
						</div>
					</div>
					<div class="form-group mb-0">
						<div class="row">
							<div class="col-md-12">
								...
								<div id="dropzone-surat-tugas" class="dropzone">
				...
				<div class="penugasan-main">
					...
					?>
							<div class="form-group">
								...
								<div class="checkbox checkbox-primary d-inline" style="padding: 0; margin: 0;">
									<input type="hidden" name="penugasan_internal" value="0" />
									...
									<input type="checkbox" name="penugasan_internal" id="checkbox-penugasan_internal" <?php print $penugasan_internal_selected; ?> value="1" />
					...
					<div class="penugasan-kegiatan-pilih" style="<?php print $showPenugasanKeg; ?>">
						<div class="form-group">
							...
							<select class="form-control" <?php print $disablePenugasanKeg; ?> id="select-kegiatan" name="kegiatan_id" required data-selected="<?php print isset($kegiatan_id) ? $kegiatan_id : "0"; ?>">
							</select>
						</div>
						<div class="form-group">
							<div class="row">
				...
				<div class="penugasan-monev" style="<?php print $showPenugasanMonev; ?>">
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<input type="text" <?php print $disablePenugasanMonev; ?> required class="form-control tgl-mulai-tugas datepicker" value="<?php print $monevGroup1["tgl_mulai_tugas"]; ?>" />
									</div>
									<div class="col-md-6">
										<label>Tgl Selesai Tugas</label>
										<input type="text" <?php print $disablePenugasanMonev; ?> required class="form-control tgl-selesai-tugas datepicker" value="<?php print $monevGroup1["tgl_selesai_tugas"]; ?>" />
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<select class="form-control provinsi-asal select2" <?php print $disablePenugasanMonev; ?> required>
											<?php
									...
									<div class="col-md-6">
										...
										<select class="form-control kab-asal select2" <?php print $disablePenugasanMonev; ?> required>
											<?php
												foreach ($provinsis as $provinsi => $provinsiKabupatens) {
													if (isset($monevGroup1["provinsi_asal"]) && $monevGroup1["provinsi_asal"] == $provinsi) {
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-6">
										...
										<select class="form-control provinsi-tujuan select2" <?php print $disablePenugasanMonev; ?> required>
											<?php
												foreach ($provinsis as $provinsi => $provinsiKabupatens) {
													$selected = "";
									...
									<div class="col-md-6">
										...
										<select class="form-control kab-tujuan select2" <?php print $disablePenugasanMonev; ?> required>
											<?php
												foreach ($provinsis as $provinsi => $provinsiKabupatens) {
													if (isset($monevGroup1["provinsi_tujuan"]) && $monevGroup1["provinsi_tujuan"] == $provinsi) {
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										...
										<textarea rows="2" required <?php print $disablePenugasanMonev; ?> class="form-control tempat-tujuan" placeholder="SMPN 6 Mengwi (Br. Gelagah Puwun, Kekeran, Mengwi, Badung)"><?php print $monevGroup1["tempat_tujuan"]; ?></textarea>
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										<label>Petugas</label>
										<select <?php print $disablePenugasanMonev; ?> class="form-control select2 petugas-monev" required value="" multiple>
											<?php
												if (isset($pegawai) && !empty($pegawai)) {
													$selectedPetugas = array();
									...
									<div class="penugasan-monev-sec">
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-6">
													<label>Tgl Mulai Tugas</label>
													<input type="text" <?php print $disablePenugasanMonev; ?> required class="form-control tgl-mulai-tugas datepicker" value="<?php print $monevGroup["tgl_mulai_tugas"]; ?>" />
												</div>
												<div class="col-md-6">
													<label>Tgl Selesai Tugas</label>
													<input type="text" <?php print $disablePenugasanMonev; ?> required class="form-control tgl-selesai-tugas datepicker" value="<?php print $monevGroup["tgl_selesai_tugas"]; ?>" />
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-12">
													<label>Tempat Tujuan</label>
													<textarea rows="2" required <?php print $disablePenugasanMonev; ?> class="form-control tempat-tujuan" placeholder="SMPN 6 Mengwi (Br. Gelagah Puwun, Kekeran, Mengwi, Badung)"><?php print $monevGroup["tempat_tujuan"]; ?></textarea>
												</div>
											</div>
										</div>
										<div class="form-group">
											<div class="row">
												<div class="col-md-12">
													<label>Petugas</label>
													<select required <?php print $disablePenugasanMonev; ?> class="form-control select2 petugas-monev" value="" multiple>
														<?php
															if (isset($pegawai) && !empty($pegawai)) {
																$selectedPetugas = array();
					...
					<div style="text-align: center; margin-top: 10px;">
						<button type="button" class="btn btn-info btn-sm add-group-monev">Tambah Group</button>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="submit" class="btn btn-info btn-modal-form-submit-penugasan" style="margin-bottom: 0;">Simpan</button>
				<button type="submit" class="btn btn-danger btn-modal-form-valid-penugasan">Kirim Validasi</button>
				<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
			</div>
		</form>
	</div>
</div>
<div class="penugasan-monev-sample" style="display: none">
	<div class="penugasan-monev-sec">
		<div class="form-group penugasan-monev-head mb-0"><label>GROUP <span class="penugasan-monev-group-no"></span></label><button type="button" class="btn btn-danger remove-monev-sec" title="Hapus Group">×</button></div>
		<hr class="mt-0 mb-3" />
		<div class="form-group">
			<div class="row">
				<div class="col-md-6">
					<label>Tgl Mulai Tugas</label>
					<input type="text" required class="form-control tgl-mulai-tugas datepicker-after-dom" value="" />
				</div>
				<div class="col-md-6">
					<label>Tgl Selesai Tugas</label>
					<input type="text" required class="form-control tgl-selesai-tugas datepicker-after-dom" value="" />
				</div>
			</div>
		</div>
		<div class="form-group">
			<div class="row">
				<div class="col-md-6">
					...
					<select class="form-control provinsi-asal select2-after-dom" required>
						<?php
							foreach ($provinsis as $provinsi => $provinsiKabupatens) {
								$selected = "";
		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-6">
					...
					<select class="form-control provinsi-tujuan select2-after-dom" required>
						<?php
							foreach ($provinsis as $provinsi => $provinsiKabupatens) {
								$selected = "";
		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-12">
					<label>Tempat Tujuan</label>
					<textarea rows="2" required class="form-control tempat-tujuan" placeholder="SMPN 6 Mengwi (Br. Gelagah Puwun, Kekeran, Mengwi, Badung)"></textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
			<div class="row">
				<div class="col-md-12">
					<label>Petugas</label>
					<select required class="form-control select2-after-dom petugas-monev" value="" multiple>
						<?php
							if (isset($pegawai) && !empty($pegawai)) {

								foreach ($pegawai as $peg) {
									print '<option value="'.$peg["id"].'">'.$peg["nama"].'</option>';
								}
							}
						?>
					</select>
