<div class="media chat-messages">
	...
	?>
	<a class="media-left photo-table" href="#!"><img class="media-object img-radius img-radius m-t-5" src="<?php print $avatar; ?>" /></a>
				...
				<table class="table table-chat-file">
					<tbody>
						...
						?>
								<tr>
									<td width="30px">
										<a href="https://drive.google.com/open?id=<?php print $driveFileId; ?>" target="_blank">
									...
									<td>
										...
										<div class="chat-file-attr">
											<div class="chat-file-size"><a href="https://drive.google.com/open?id=<?php print $driveFileId; ?>" target="_blank"><?php print $size; ?></a></div>
										</div>
									</td>
								</tr>
						<?php
											...
											<table class="table table-chat-file">
												<tbody>
													...
													?>
															<tr>
																<td width="30px">
																	<a href="https://drive.google.com/open?id=<?php print $driveFileId; ?>" target="_blank"><i class="chat-file-icon fas <?php print $icon; ?>"></i></a>
																</td>
																<td>
																	<h6 class="m-0"><a href="https://drive.google.com/open?id=<?php print $driveFileId; ?>" target="_blank" class="" title="<?php print $nama; ?>"><?php print $nama; ?></a></h6>
																	<div class="chat-file-attr">
